...
// React.lazy en vez de next/dynamic: este paquete (packages/ui) no depende de
// `next`. El componente solo se renderiza en cliente (guard `isMounted`), así que
// el import diferido equivale al `ssr: false` que teníamos.
const Lottie = lazy(() => import("lottie-react")) as unknown as ComponentType<{
  // biome-ignore lint/suspicious/noExplicitAny: props de lottie-react sin tipar aquí
  [key: string]: any;
}>;
